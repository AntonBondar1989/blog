...
function TomatoTimer() {
  ...
  return (
    <div className='tomato_box' >
      ...
      <div className='wer'>
        {isActive ? (
          <button className='btn_pause_tomato' onClick={handlePause}><img src='/img/tomato/pause1.png' alt="pause" /></button>
        ) : (
          <button className='btn_start_tomato' onClick={handleStart}><img src='/img/tomato/play3.png' alt="play" /></button>
        )}
        <button className='btn_reset_tomato' onClick={handleReset}><img src='/img/tomato/stop.png' alt="stop" /></button>
      </div>
    </div>
  );
}
